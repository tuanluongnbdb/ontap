...
export const HISTORY_DATA: Topic[] = [
  ...
  {
    id: 'topic-7',
    title: 'CHỦ ĐỀ 7: CÁC DÂN TỘC TRÊN ĐẤT NƯỨC VIỆT NAM',
    questions: [
      {
        id: 1,
        type: 'choice',
...
export const BIOLOGY_DATA: Topic[] = [...BIOLOGY_PART_1, ...BIOLOGY_PART_2];
    ...
    questions: [
      {
        ...
        answer: [
          ...
          'Nam is only 14 years old, but he plays soccer very well.'
        ],
      ...
      },
      {
        ...
        answer: [
          ...
          'The girl, whose electronic dictionary is not working, looked very upset.',
          'The girl looked very upset because her electronic dictionary was not working.'
        ],
        hint: 'Use a relative pronoun'
      },
      {
